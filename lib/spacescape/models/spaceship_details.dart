...
class Spaceship {
  ...
  static const Map<SpaceshipType, Spaceship> spaceships = {
    SpaceshipType.canary: Spaceship(
      ...
      speed: 250,
      spriteId: 0,
      assetPath: 'assets/images/spacescape/ship_A.png',
      level: 1,
    ),
    SpaceshipType.dusky: Spaceship(
      ...
      speed: 400,
      spriteId: 1,
      assetPath: 'assets/images/spacescape/ship_B.png',
      level: 2,
    ),
    SpaceshipType.condor: Spaceship(
      ...
      speed: 300,
      spriteId: 2,
      assetPath: 'assets/images/spacescape/ship_C.png',
      level: 2,
    ),
    SpaceshipType.cXC: Spaceship(
      ...
      speed: 300,
      spriteId: 3,
      assetPath: 'assets/images/spacescape/ship_D.png',
      level: 3,
    ),
    SpaceshipType.raptor: Spaceship(
      ...
      speed: 300,
      spriteId: 4,
      assetPath: 'assets/images/spacescape/ship_E.png',
      level: 3,
    ),
    SpaceshipType.raptorX: Spaceship(
      ...
      speed: 350,
      spriteId: 5,
      assetPath: 'assets/images/spacescape/ship_F.png',
      level: 3,
    ),
    SpaceshipType.albatross: Spaceship(
      ...
      speed: 400,
      spriteId: 6,
      assetPath: 'assets/images/spacescape/ship_G.png',
      level: 4,
    ),
    SpaceshipType.dK809: Spaceship(
      ...
      speed: 450,
      spriteId: 7,
      assetPath: 'assets/images/spacescape/ship_H.png',
      level: 4,
    ),
  };
}
