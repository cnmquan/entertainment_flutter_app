...
class SpacescapeGame extends FlameGame
  ...
  Future<void> onLoad() async {
    ...
    if (!_isAlreadyLoaded) {
      ...
      // assets/images/spacescape/simpleSpace_tilesheet@2.png
      await images.loadAll([
        'spacescape/simpleSpace_tilesheet@2.png',
        'spacescape/freeze.png',
        'spacescape/icon_plusSmall.png',
        'spacescape/multi_fire.png',
        'spacescape/nuke.png',
      ]);
      ...
      final stars = await ParallaxComponent.load(
        [
          ParallaxImageData('spacescape/stars1.png'),
          ParallaxImageData('spacescape/stars2.png')
        ],
      ...
      spriteSheet = SpriteSheet.fromColumnsAndRows(
        image: images.fromCache('spacescape/simpleSpace_tilesheet@2.png'),
        columns: 8,
        rows: 6,
      );
  ...
  void onAttach() {
    ...
    _audioPlayerComponent.playBgm('spacescape/9. Space Invaders.wav');
    super.onAttach();
  }
