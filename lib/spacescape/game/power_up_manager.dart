...
class PowerUpManager extends Component
  ...
  void onMount() {
    ...
    healthSprite =
        Sprite(gameRef.images.fromCache('spacescape/icon_plusSmall.png'));
    nukeSprite = Sprite(gameRef.images.fromCache('spacescape/nuke.png'));
    freezeSprite = Sprite(gameRef.images.fromCache('spacescape/freeze.png'));
    multiFireSprite =
        Sprite(gameRef.images.fromCache('spacescape/multi_fire.png'));
